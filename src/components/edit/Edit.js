...
class Edit extends Component {
  ...
  saveImage(props) {
    ...
    axios
      .patch(`/alterdream/${this.state.text}/${id}`)
      .then(this.props.history.push(`/mydreams`));
  }
      ...
      <div>
        ...
        <div className="edit-component">
          <div className="editPreviewComponent">
            ...
            <div className="state">{this.state.text}</div>
            <textarea value={text} onChange={e => this.updateText(e)} />
            <br />
            <button className="home-btn" onClick={this.saveImage}>
              Save
            </button>
          </div>
        </div>
